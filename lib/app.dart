import 'package:alphabet/core/constants/scroll_behavior.dart';
...
class App extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final MediaQueryData appMediaQuery = MediaQuery.of(context).copyWith(textScaler: const TextScaler.linear(1));
